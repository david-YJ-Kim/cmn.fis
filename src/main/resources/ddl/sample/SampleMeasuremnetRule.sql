...
insert into CN_FIS_PARSE_RULE_REL (OBJ_ID, EQP_ID, FILE_TYP, FILE_CLM_VAL, FILE_CLM_NM,MPNG_CLM_NM, CLM_DATA_TYP,
                                   CRT_DT, CRT_USER_ID, MDFY_DT, MDFY_USER_ID)
values ('202404180111351133-d5f90065-8923-4cfd-b18d-94e7c3d89a_14', 'AP-PD-11-01', 'MEASUREMENT', 'N', 'POS_X_VAL','POS_X_VAL', 'NUMBER',
        SYSDATE, 'David', SYSDATE, 'David'
       );

insert into CN_FIS_PARSE_RULE_REL (OBJ_ID, EQP_ID, FILE_TYP, FILE_CLM_VAL, FILE_CLM_NM,MPNG_CLM_NM, CLM_DATA_TYP,
                                   CRT_DT, CRT_USER_ID, MDFY_DT, MDFY_USER_ID)
values ('202404180111351133-d5f90065-8923-4cfd-b18d-94e7c3d89a_15', 'AP-PD-11-01', 'MEASUREMENT', 'O', 'POS_Y_VAL','POS_Y_VAL', 'NUMBER',
        SYSDATE, 'David', SYSDATE, 'David'
       );

insert into CN_FIS_PARSE_RULE_REL (OBJ_ID, EQP_ID, FILE_TYP, FILE_CLM_VAL, FILE_CLM_NM,MPNG_CLM_NM, CLM_DATA_TYP,
                                   CRT_DT, CRT_USER_ID, MDFY_DT, MDFY_USER_ID)
values ('202404180111351133-d5f90065-8923-4cfd-b18d-94e7c3d89a_16', 'AP-PD-11-01', 'MEASUREMENT', 'P', 'POS_Z_VAL','POS_Z_VAL', 'NUMBER',
        SYSDATE, 'David', SYSDATE, 'David'
       );
